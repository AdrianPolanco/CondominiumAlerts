...
{
    public class GetCondominiumsJoinedByUserCommandHandler : ICommandHandler<GetCondominiumsJoinedByUserCommand, Result<List<GetCondominiumsJoinedByUserResponce>>>
    {
        ...
        public async Task<Result<List<GetCondominiumsJoinedByUserResponce>>> Handle(GetCondominiumsJoinedByUserCommand request, CancellationToken cancellationToken)
        {
            ...
            if (!validResult.IsValid)
            {
                ...
                return Result.Fail<List<GetCondominiumsJoinedByUserResponce>>(String.Join(", ", erros));
            }
            ...
            if(! await _userRepository.AnyAsync(u => u.Id == request.UserId, cancellationToken))
            {
                ...
                return Result.Fail<List<GetCondominiumsJoinedByUserResponce>>("No user was found");
            }
            ...
            if (condominiums is null)
            {
                ...
                return Result.Fail<List<GetCondominiumsJoinedByUserResponce>>("Error getting the user condominium's");
            }

            return Result<List<GetCondominiumsJoinedByUserResponce>>.Ok(condominiums.Select(cu => new GetCondominiumsJoinedByUserResponce(cu.Id, cu.Condominium.Name, cu.Condominium.Address, cu.Condominium.ImageUrl)).ToList());
