...
namespace CondominiumAlerts.Features.Features.Condominiums.Join
{
    public class JoinCondominiumValidator : AbstractValidator<JoinCondominiumCommand>
    {
        public JoinCondominiumValidator() { 
            ...
            RuleFor(jc => jc.CondominiumCode).MinimumLength(11).WithMessage("The code is too short, it must be 11 characters long");
            RuleFor(jc => jc.CondominiumCode).MaximumLength(11).WithMessage("The code is too long, it must be 11 characters long");
        }
    }
}
