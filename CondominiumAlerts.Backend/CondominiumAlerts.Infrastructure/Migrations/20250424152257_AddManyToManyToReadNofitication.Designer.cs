...
namespace CondominiumAlerts.Infrastructure.Migrations
{
    ...
    [Migration("20250424152257_AddManyToManyToReadNofitication")]
    partial class AddManyToManyToReadNofitication
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CondominiumAlerts.Domain.Aggregates.Entities.NotificationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CondominiumAlerts.Domain.Aggregates.Entities.NotificationUser", b =>
                {
                    b.HasOne("CondominiumAlerts.Domain.Aggregates.Entities.Notification", "Notification")
