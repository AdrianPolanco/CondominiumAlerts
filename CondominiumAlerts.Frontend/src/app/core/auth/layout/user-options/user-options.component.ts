...
import { interval, merge, mergeAll, startWith, Subject, switchMap, takeUntil, tap } from 'rxjs';
...
export class UserOptionsComponent {
    ...
    constructor(
        ...
        merge(
            ...
            this.eventService.notification$
        ).pipe(takeUntil(this.destroy$)).subscribe(notification => {
